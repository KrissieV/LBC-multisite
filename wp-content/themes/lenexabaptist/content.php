...
<div class="col span_8_of_12">
	...
	<div class="entry-content">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'lenexabaptist' ) ); ?>
		<?php
			wp_link_pages( array(
	...
	<footer class="entry-footer">
		...
		| <span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'lenexabaptist' ), __( '1 Comment', 'lenexabaptist' ), __( '% Comments', 'lenexabaptist' ) ); ?></span>
		<?php endif; ?>
